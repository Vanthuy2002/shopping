...
const ModalEditUser = forwardRef(
      ...
      >
        ...
        >
          ...
          <form className='shadow dark:bg-gray-700' autoComplete='off'>
            ...
            <FlexLayout className='p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600'>
              <Button size='lg'>Save all</Button>
            </FlexLayout>
          </form>
        </div>
        <Tooltip id='modal-tootip' />
      </div>
    );
  }
);
